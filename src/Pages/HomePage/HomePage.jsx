  ...
  const handleAddToCart = async (product) => {
    ...
    try {
      const response = await fetch(
        "https://build-with-innovation-server-side.vercel.app/orders",
        {
          method: "POST",
          headers: {
                ...
                return (
                  <div key={product.id} className="product">
                    ...
                    <div className="mt-5 px-4">
                      ...
                      <p className="text-[16px] mb-2">{product.description}</p>
